...
public class AccessTokenRetrievalException extends Exception {
	...
	public AccessTokenRetrievalException(String msg) {
		super(msg);
	}
	
	public AccessTokenRetrievalException(Throwable cause) {
		super(cause);
	}

	public AccessTokenRetrievalException(String msg, Throwable cause) {
		super(msg, cause);
	}
